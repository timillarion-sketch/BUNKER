...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    subsections: [
      ...
      },
      {
        ...
        icon: Cookie,
        text: "Демо-менеджер куков. В текущей версии работает с локальными тестовыми данными и не влияет на реальные cookie браузера.",
        color: "#ffd700",
      },
    ],
  },
    ...
    subsections: [
      {
        ...
        title: "Шифрование",
        icon: Lock,
        text: "Демо-режим. Сквозное шифрование (E2E) не реализовано в текущей версии. Сообщения передаются и хранятся без криптографической защиты.",
        color: "#00f0ff",
      },
      {
        id: "mesh-network",
  ...
  },
  {
    ...
    title: "ПРОФИЛЬ",
    icon: UserCircle,
    preview: "Центр управления профилем. UI-концепт — реальная серверная авторизация не реализована.",
    color: "#bf00ff",
    subsections: [
      {
        id: "ghost-mode",
      ...
      },
      {
        ...
        icon: Wifi,
        text: "UI-концепт приватной маршрутизации. В текущей версии ключ хранится локально и не влияет на сетевой трафик.",
        color: "#00ff88",
      },
      {
        id: "protocol-zero",
