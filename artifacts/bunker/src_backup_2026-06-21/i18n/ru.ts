const ru = {
  ...
  login: {
    tagline1:   "Защищённый узел связи.",
    tagline2:   "Шифрование RSA-OAEP 2048",
    secureNode: "Защищённый вход",
  ...
  chats: {
    ...
    e2eActive:     "E2E Активен",
    protocolTitle: "Канал связи",
    protocolDesc:  "Соединение защищено (WebCrypto API). Все сообщения шифруются.",
